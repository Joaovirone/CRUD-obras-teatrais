...
interface RegisterFormProps {
  ...
  onSenhaConfirmChange: (text: string) => void;
  onSubmit: () => void;
  loading: boolean;
  error?: string;
}
  ...
  return (
    ...
    >
      <View style={styles.headerContainer}>
        ...
        <Text style={styles.subtitle}>Comece sua jornada no teatro</Text>
      </View>
      ...
      <View style={styles.fieldsContainer}>
        ...
        <LabeledInput
          ...
          value={senhaConfirm}
          onChangeText={onSenhaConfirmChange}
          editable={!loading}
          secureTextEntry
          error={error}
        />
...
const styles = StyleSheet.create({
  ...
  primaryButtonText: {
    color: Colors.gradients.register.start,
    fontWeight: '700',
    fontSize: 16,
    letterSpacing: 1,
  },
